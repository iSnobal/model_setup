...
Required python libraries: numpy and pandas
...
### Notes
The canopy keyword dictionary and class-priority order are defined in the notebook and directly affect assigned classes and parameters. If you modify keyword mappings or priority/order, regenerate the output CSV and review differences. To preserve data provenance, future updates to notebook and data occur in the same commit.
...
*Link, T. and Marks, D. (1999), Distributed simulation of snowcover mass- and energy-balance in the boreal forest. Hydrol. Process., 13: 2439-2452. [https://doi.org/10.1002/(SICI)1099-1085(199910)13:14/15<2439::AID-HYP866>3.0.CO;2-1](https://doi.org/10.1002/(SICI)1099-1085(199910)13:14/15<2439::AID-HYP866>3.0.CO;2-1)*